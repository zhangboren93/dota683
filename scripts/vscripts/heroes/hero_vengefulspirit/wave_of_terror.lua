...
function WaveOfTerrorVision( keys )
	...
	caster:SetThink(function()
		...
		wave_location = wave_location + forwardVec * (wave_speed / 10)
	...
	end, "wave of terror gives vision", 0.1)
end
...
function handleProjectileHitUnit(event)
	...
	ability:ApplyDataDrivenModifier(caster, target, "modifier_wave_of_terror_datadriven",
