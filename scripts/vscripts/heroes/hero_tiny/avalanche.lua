...
function handleSpellStart(event)
	...
	if caster.avalanche_particle == nil then
		...
		ParticleManager:SetParticleControl(caster.avalanche_particle, 0, target_point)
		ParticleManager:SetParticleControl(caster.avalanche_particle, 1, Vector(225, 1, 1))
	end
