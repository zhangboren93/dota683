ITEM_RECIPE_RULES = {
    ...
    {"item_dagon", "item_recipe_dagon", "item_staff_of_wizardry", "item_null_talisman_datadriven"},
    {"item_dagon_2", "item_recipe_dagon", "item_dagon"},
    {"item_dagon_3", "item_recipe_dagon", "item_dagon_2"},
    {"item_dagon_4", "item_recipe_dagon", "item_dagon_3"},
    {"item_dagon_5", "item_recipe_dagon", "item_dagon_4"},
    ...
    {"item_vanguard", "item_ring_of_health", "item_vitality_booster"},
    {"item_crimson_guard", "item_recipe_crimson_guard", "item_vanguard", "item_buckler_2"},
        ...
        for i=1,#ITEM_RECIPE_RULES do
            ...
            if can_combine then
                for j=1,#ingrediants_cache do
                    --print("Destorying item " .. ingrediants_cache[j]:GetName())
