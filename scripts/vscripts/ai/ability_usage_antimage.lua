...
function ConsiderManaVoid(abilityMV, nearbyEnemyHeroes)
	...
	local actualDmgLowest = GetActualIncomingDamage(lowestManaHero,  aoeDmg, DAMAGE_TYPE_MAGICAL )
	
	if channelingHero ~= nil and channelingHero:GetHealth() < GetActualIncomingDamage(channelingHero, aoeDmg, DAMAGE_TYPE_MAGICAL ) 
